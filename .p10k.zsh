# Generated by Powerlevel10k configuration wizard on 2020-05-10 at 11:40 BST.
...
# sharp tails, 2 lines, disconnected, left frame, lightest-ornaments, sparse, concise,
...
() {
  ...
  # This looks better with new W10 emoji
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=157
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=56
